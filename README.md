<div align="center">
  ...
  <h3 align="center">Flutter Expenses App</h3>

  <p align="center">
    This is second project of my path about being a "Flutter Developer".
...
* Used functions like .map(), .where(), .removeWhere() etc.
* Used collections like List, Map, Set etc.
* Used classes like DateTime, Duration etc.
* Created and worked with custom classes models.
* Used 3rd party libraries like [intl](https://pub.dev/packages/intl) for internationalization.
* Used [DateTime] for date and time.
* Et cetera.

Of course this is not a complete list of features, but I am feeling 'Improvement'.
...
- [x] Learn basic Flutter widgets
- [x] Learn basic Flutter layout
- [x] Learn passing data between seperated widgets
- [x] Learn control data with ternary operators and null-aware operators
- [x] Learn creating objects with classes
- [x] Learn how to control objects with methods
- [x] Learn how to control assets and fonts with [pubspec.yaml]
- [ ] Improve the expenses app with more features
- [ ] Improve the expenses app with more UI
- [ ] Improve the expenses app with more animations
- [ ] Create database for the expenses app
